...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>欢迎<?php echo ($_SESSION['USERINFO']['username']); ?>来到京西！  <?php if(empty($_SESSION['USERINFO'])): ?>[<a href="<?php echo U('Member/login');?>">登录</a>] [<a href="<?php echo U('Member/reg');?>">免费注册</a>] <?php else: ?>  [<a href="<?php echo U('Member/logout');?>">注销</a>]<?php endif; ?> </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<?php if(is_array($historys)): $i = 0; $__LIST__ = $historys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$history): $mod = ($i % 2 );++$i;?><dl>
						<dt><a href="<?php echo U('goods',array('id'=>$history['id']));?>"><img src="http://itsource-goods.b0.upaiyun.com//<?php echo ($history["logo"]); ?>!small" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="http://itsource-goods.b0.upaiyun.com/<?php echo ($paths[0]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://itsource-goods.b0.upaiyun.com/<?php echo ($paths[0]); ?>!big" alt=""  style="max-width: 350px;max-height: 350px"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($paths)): $i = 0; $__LIST__ = $paths;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$path): $mod = ($i % 2 );++$i;?><li   <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>>
									<a <?php if(($i) == "1"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://itsource-goods.b0.upaiyun.com//<?php echo ($path); ?>!big',largeimage: 'http://itsource-goods.b0.upaiyun.com//<?php echo ($path); ?>'}"><img src="http://itsource-goods.b0.upaiyun.com//<?php echo ($path); ?>!small"></a>
	...
	<script type="text/javascript">
		$(function(){
			...
			var intro  = $('.desc').text();//先得到被编码的html
